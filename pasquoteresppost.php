...
<?php
    $s="";
    $requeststr="editorValue=".urlencode($_POST["editorValue"])."&attfile=".urlencode(basename($_FILES['attfile']['name']))."&tid=".$_GET["tid"];
    ...
    $s=$bizsession->request(5,26,0,$requeststr."&fileid=".$s);
