...
<?php
    $s="";
    $requeststr="em=".$_POST["em"]."&subject=".urlencode($_POST["subject"])."&myEditor=".urlencode($_POST["myEditor"])."&attfile=".urlencode(basename($_FILES['attfile']['name']))."&bid=".$_GET["bid"];
    ...
    $s=$bizsession->request(5,14,0,$requeststr."&fileid=".$s);
